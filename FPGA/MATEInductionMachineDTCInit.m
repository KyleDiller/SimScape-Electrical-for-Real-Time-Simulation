%% Parameters for Asynchronous Machine Direct Torque Control Example

% This example shows how to control an asynchronous machine (ASM) using 
% the direct-torque control method. A PI-based speed controller supplies 
% the torque reference. The direct-torque controller generates the inverter 
% pulses.
...
%% Control parameters
%%Ts = 2e-6;        % s,  fundamental sample time
